					...
					success: (res) => {
						...
						uni.uploadFile({ //上传照片
							...
							success: (uploadFileRes) => {
								...
								console.log(_this.emoType);
								console.log(_this.faceType);
								console.log(_this.beauty);
								console.log(_this.age);
								console.log(_this.emoTag);
								console.log(_this.src);
								if(_this.judgeVoid(_this.emoType))
									_this.close1 = true;
								if(_this.judgeVoid(_this.faceType))
									_this.close2 = true;
								if(_this.iniBeauty != -1)
									_this.close3 = true;
								if(_this.iniAge != -1)
									_this.close4 = true;
								if(_this.close1 == false && _this.close2 == false && _this.close3 == false && _this.close4 == false)
									_this.close6 = true;
							}
						})	
					}
